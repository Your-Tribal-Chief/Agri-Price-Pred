...
def send_sms_alert(to_number, message_body):
    ...
    try:
        ...
        # Fallback for local testing (set these in .streamlit/secrets.toml)
        return False, "Twilio credentials not configured. Please add them to .streamlit/secrets.toml"
